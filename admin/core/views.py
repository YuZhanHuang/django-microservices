...
class ProfileInfoAPIView(APIView):
    ...
    def put(self, request, pk=None):
        return Response(UserService.put(f'users/info', data=json.dumps(request.data), headers=request.headers))


class ProfilePasswordAPIView(APIView):

    def put(self, request, pk=None):
        return Response(UserService.put(f'users/password', data=json.dumps(request.data), headers=request.headers))
...
class ProductGenericAPIView(
    ...
    def delete(self, request, pk=None):
        ...
        producer.produce('ambassador_topic', key='product_deleted', value=json.dumps(pk))
        producer.produce('checkout_topic', key='product_deleted', value=json.dumps(pk))
